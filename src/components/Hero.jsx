...
export default function Hero({ isExpanded, setIsExpanded }) {
  ...
  return (
    ...
    >
      ...
      >
        <motion.div className="flex items-start overflow-hidden" layout transition={{ duration: 0.6 }}>
          <motion.h1
        ...
        <AnimatePresence>
          {isExpanded && (
            <motion.div key="expanded-content" className="lg:w-[820px] flex flex-col items-start gap-[24px] text-left">
              <p className="font-light text-[16px] lg:text-[20px] text-gray-800">
                At Basira, we design to simplify.
                <br />
                To make things feel clear, intuitive, and grounded in meaning. <br />
                Whether it's a brand, a space, or a story — we build with intention, so what you create feels effortless
                to experience.
              </p>
              <p className="font-light text-[16px] lg:text-[20px] text-gray-800">
